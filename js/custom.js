$(document).ready(function(){
	...
	$('#honorsAwards li:nth-child(2) a').on('click',function(e){
		e.preventDefault();
		if($('#honorsAwards li:first-child').css('opacity')==0){
			$('#honorsAwards li:first-child').css('opacity',1);
		}else{
			$('#honorsAwards li:first-child').css('opacity',0);
		}
	})
